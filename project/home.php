...
?>
  ...
  <?php  
    ...
    $query = "SELECT * FROM postproperty ORDER BY date desc LIMIT 1";
  ...
  <div class="listing-container">
          ...
          <div class="listing-left">
                  ...
                  <div class="listing-save-btn">
                        ...
                        <button class="comment-button">
                               <a href="comments.php?property_id=<?php echo $property_id; ?>&prev=<?php echo urlencode($_SERVER['REQUEST_URI']); ?>">
            ...
            <div class="listing-data">
              ...
              <div class="address">
                <p>
                  ...
                  ><span><?php echo htmlspecialchars($row['address'].",".$row['city']); ?></span>
                </p>
              </div>
    ...
    <div class="view_more">
     <button class="btn_view_more"><a href="all_listing.php">View More</a>
     <i class="fa fa-angle-down" aria-hidden="true" style="color:white; padding-left:5px; font-size:24px"></i></button>
    </div>
    <?php  
    } else {
      echo'
