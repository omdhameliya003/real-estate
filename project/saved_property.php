...
<body>
    ...
    $query = "SELECT p.* FROM saved_properties s 
    JOIN postproperty p ON s.property_id = p.id 
    WHERE s.user_id = '$saveby_user' 
                    ...
                    <div class="listing-right">
                        <div class="listing-data">
                            ...
                            <p>
                              ...
                              $icon = 'fa fa-home'; // Default icon home if type is unknown
                               }
                                ?>
