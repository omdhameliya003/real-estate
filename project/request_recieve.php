...
// Fetch requests RECEIVED for the user's properties
$received_request_query = "SELECT request.id AS request_id, request.property_id, request.request_date, 
                           ...
                           WHERE postproperty.user_id COLLATE utf8mb4_general_ci = '$user_id' 
...
<body>
    ...
    <div class="requiest-container">
        ...
        <div class="requiest-cards">
            <?php if (mysqli_num_rows($received_request_result) > 0) { ?>
                <?php while ($row = mysqli_fetch_assoc($received_request_result)) { ?>
